...
namespace MyClass8
{
    internal class Class1
    {
        ...
        public  void valueTypeAndRefferenceType()
        {
             ...
             * int number = (int)objectValue;       //언박싱,캐스팅
             * 
        ...
        public void whatIsDestructor()
        {
             ...
             * 메서드 이다. 자동차 클래스를 예를 들면 자동차 주차 대행, 시동 끄기 등으로 볼 수 있다.
             * 
             * 종료자      // 클래스를 알아서 닫아준다.
        ...
        public void WhatIsInheritance()
        {
             ...
             *  파생 클래스는 다른 크래스에서 맴버를 물려받는 것으로, Derived 클래스, sub 클래스,
             *  자식 클래스로 표현한다.
             *  
             * 부모 클래스와 자식 클래스
             * 프로그램밍에서 상속을 표현할 떄 상속을 주는 클래스를 부모 클래스라고 하며, 상속을 받는 클래스를
             * 자식 클래스라고 한다. 콜론(:) 기호로 상속 관계를 지정하면 부모 클래스의 public 맴버들을
