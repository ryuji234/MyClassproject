...
namespace RyuClass7
{
    internal class Class1
    {
        ...
        static void Card()
        {
            ...
            Card.Name = "Ryu JiHwan";
            Card.Age = 27;
            Card.Address = "성남시 분당구";
            Console.WriteLine($"\n\n\n\t 이름: {Card.Name} \t 나이: {Card.Age} \n\n\t 주소: {Card.Address}");
        ...
        static void WhatisStructure()
        {
             ...
             * 배열을 확장하여 이름 하나로 데이터 형식을 1개 또는 여러개 보관하는 그릇 역할을 하는 것이 
             * 바로 구조체이다.
             * 
            ...
            Pointer Point = new Pointer();    //Pointer 구조체 형식의 변수 선언
            Point.x = 100;
            Point.y = 200;
            Point.myNewNumber = 2000;
            Point.myName = "RYU";
