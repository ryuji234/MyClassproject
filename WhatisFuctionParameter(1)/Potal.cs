...
namespace WhatisFuctionParameter
{
    internal class Potal
    {
        ...
        public static void Main()
        {
            ...
            int MoveX = 1;
            int MoveY = 1;
            int[,] gameBoard = new int[BOARD_SIZE_X, BOARD_SIZE_Y];
            bool CoinIsHere = false;
            int RoomX = 0;
            int RoomY = 0;
            int[,] RoomClear = new int[5, 5]; 
            RoomMaker room = new RoomMaker();
            gameBoard = room.RoomCoinCheck(RoomX, RoomY, RoomClear[RoomX, RoomY]);
                    ...
                    switch (Move)
                    {
                        case 'a':
                            ...
                            else if (gameBoard[MoveX - 1, MoveY] == 2 && CoinIsHere == false)
                            {
                                ...
                                gameBoard = room.RoomCoinCheck(--RoomX, RoomY, RoomClear[RoomY, RoomX]);
                                gameBoard[MoveX, MoveY] = 0;
